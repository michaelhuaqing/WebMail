...
(function(){
  ...
  var HalfViz = function(elt){
    ...
    var that = {
      ...
      getDoc:function(e){
        $.getJSON('..static/library/'+e.id+'.json', function(doc){
      ...
      newDoc:function(){
        ...
        var test = "{color:green}\nmichael@gmail.com->zhangsan@qq.com\n"+
		"michael@gmail.com->lisi@163.com\n"+
		"michael@gmail.com->wangwu@126.com\n"+
		"michael@gmail.com->wangwu@qq.com\n"+
		"michael@gmail.com->lucy@126.com\n"+
		"michael@gmail.com->michalhuaqing@126.com\n"+
		"lucy@126.com->tom@sina.com\n"+
		"lucy@126.com->zhangsan@qq.com\n"+
		"lucy@126.com->mayun@sohu.com\n"
        _code.val(test).focus()
        $.address.value("")
        that.updateGraph()
        that.resize()
        _editing = false
